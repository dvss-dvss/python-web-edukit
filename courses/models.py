...
class Subject(models.Model):
    ...
    class Meta:
        verbose_name = 'Спецiалiзацiя'
        verbose_name_plural = 'Спецiалiзацiї'
        ordering = ['title']
...
class Course(models.Model):
    ...
    subject = models.ForeignKey(Subject, related_name='courses', on_delete=models.CASCADE, verbose_name="Спецiалiзацiя")
